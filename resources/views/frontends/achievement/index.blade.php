...
<main>
    ...
    <section class="breadcrumb bg_img ul_li" data-background="{{ asset('frontends/front_school.jpg') }}">
        <div class="container">
            <div class="breadcrumb__content text-center">
                <h2 class="breadcrumb__title">Prestasi</h2>
                <p class="breadcrumb__desc">Prestasi SD Kartini II</p>
            </div>
        </div>
    </section>
    <!-- breadcrumb end -->
    ...
    <section class="event pt-120 pb-120" data-bg-color="#f1f1e9">
                ...
                <div class="col-lg-6 mt-30">
                    <div class="xb-event-item">
                        <div class="xb-item--img">
                            <a href="{{ url('prestasi'. '/'. $item->slug) }}"><img src="{{ url('storage/'. $item->image) }}"
                                    alt="{{ $item->image }}"></a>
                        </div>
                        <div class="ul_li xb-item--wrap">
                            <div class="xb-item--content">
                                <h2 class="xb-item--title border-effect"><a
                                        href="{{ url('prestasi/'.$item->slug) }}">{{ Str::limit($item->title, 53, '...') }}</a></h2>
                                <div class="xb-event-btn pt-15">
                                    <a class="thm-btn" href="{{ url('prestasi/'.$item->slug) }}">Selengkapnya
        ...
        {{ $allAchievement->links('vendor.pagination.custom') }}
    </section>
    <!-- event end -->
