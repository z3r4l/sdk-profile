    ...
    <section class="breadcrumb bg_img ul_li" data-background="{{ asset('frontends/front_school.jpg') }}">
        <div class="container">
            <div class="breadcrumb__content text-center">
                <h2 class="breadcrumb__title">Fasilitas</h2>
                <p class="breadcrumb__desc">Fasilitas SD Kartini II</p>
            </div>
        </div>
    </section>
    <!-- breadcrumb end -->
                ...
                <div class="col-lg-4 mt-30">
                    <aside class="sidebar ps-xl-5">
                        <div class="post_list_block">
                            <h3 class="sidebar_widget_title">Fasilitas Lainnya</h3>
                            <ul class="unordered_list_block">
                                @foreach ($allFacility as $item)
                                <li>
                                    <div class="post_image">
                                        <a href="{{ url('fasilitas'. '/'. $item->slug) }}"><img
                                                src="{{ url('storage/'. $item->image) }}" alt="{{ $item->image }}"></a>
                                    </div>
                                    <div class="post_holder">
                                        <h3 class="post_title border-effect-2">
                                            <a href="{{ url('fasilitas'. '/'. $item->slug) }}">
